...
const fa: Dictionary = {
  ...
  about: {
    ...
    terminal_clearance: "نمایه: AI-SECURITY-RESEARCHER",
  ...
  writeups_page: {
    classified_archive: "آرشیو پروژه‌ها",
    title: "گزارش‌ها",
    description: "تحلیل‌های فنی، راهکارهای CTF و لاگ‌های مهندسی.",
    clearance_level: "نمایانی: عمومی",
  ...
  contact_form: {
    ...
    status_keylogging: "برقراری کانال امن...",
    status_encrypting: "در حال رمزنگاری...",
