...
const zh: Dictionary = {
  ...
  about: {
    ...
    terminal_online: "在线",
    terminal_clearance: "档案：AI-SECURITY-RESEARCHER",
    ...
    spec2_item1: "大语言模型集成与评估（Claude，经 Alignerr）",
  ...
  writeups_page: {
    classified_archive: "项目归档",
    title: "文章",
    description: "技术分析、CTF 解题报告及工程日志。",
    clearance_level: "可见性：公开",
    read_file: "阅读文件",
  },
  projects_page: {
    title: "项目数据库",
