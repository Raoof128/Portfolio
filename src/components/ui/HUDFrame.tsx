        ...
        <div className={cn("relative p-6 border border-cyan/10 glass", className)} {...props}>
            ...
            {corners && (
                <>
                    ...
                    >
                        <span className="absolute -top-[2px] -left-[2px] w-1 h-1 bg-cyan shadow-[0_0_6px_rgba(81,40,136,0.8)]" />
                    </motion.div>
                    <motion.div
                        custom={1}
                        initial="hidden"
                    ...
                    >
                        <span className="absolute -top-[2px] -right-[2px] w-1 h-1 bg-cyan shadow-[0_0_6px_rgba(81,40,136,0.8)]" />
                    </motion.div>
                    <motion.div
                        custom={2}
                        initial="hidden"
                    ...
                    >
                        <span className="absolute -bottom-[2px] -left-[2px] w-1 h-1 bg-cyan shadow-[0_0_6px_rgba(81,40,136,0.8)]" />
                    </motion.div>
                    <motion.div
                        custom={3}
                        initial="hidden"
                    ...
                    >
                        <span className="absolute -bottom-[2px] -right-[2px] w-1 h-1 bg-cyan shadow-[0_0_6px_rgba(81,40,136,0.8)]" />
                    </motion.div>
                </>
            )}
