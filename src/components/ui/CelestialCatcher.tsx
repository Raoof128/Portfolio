      ...
      <div className="cc-container">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <g className="cc-cloud-l" fill={BG} stroke={LINE} strokeWidth="3">
            <path
              d="M 25,120 C 15,120 10,130 15,138 C 10,145 18,155 28,152 C 35,155 45,150 43,140 C 48,132 40,120 25,120 Z"
              opacity="0.4"
            />
          </g>
          <g className="cc-cloud-r" fill={BG} stroke={LINE} strokeWidth="3">
            <path
              d="M 170,70 C 160,70 155,78 160,86 C 155,93 162,101 172,98 C 178,101 188,96 186,88 C 191,80 182,70 170,70 Z"
              opacity="0.4"
            />
          </g>
          ...
          <g className="cc-moon">
            <path
              d="M 140,40 C 90,40 60,75 60,120 C 60,165 90,200 140,200 C 105,180 90,150 90,120 C 90,90 105,60 140,40 Z"
              fill={PAGE}
              stroke={LINE}
              strokeWidth="3.5"
              strokeLinejoin="round"
            ...
            <g transform="translate(100,105)">
              <g transform="rotate(30) translate(0,-50)">
                <use href="#cc-star" />
              </g>
              <g transform="rotate(150) translate(0,-50)">
                <use href="#cc-star" transform="scale(0.8)" />
              </g>
            </g>
          </g>
