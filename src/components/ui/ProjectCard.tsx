...
export function ProjectCard({ title, description, tags, buildItems, secureItems, links, featured = false }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <HUDFrame className={cn("flex flex-col h-full hover:shadow-[0_0_30px_rgba(124,77,189,0.1)] transition-shadow duration-300", featured ? "lg:col-span-2" : "")} title="PROJECT_MODULE">
