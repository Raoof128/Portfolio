...
const BOOT_SEQUENCE: RawLog[] = [
  ...
  { msg: "  Role    AI & Cybersecurity Researcher", color: "text-purple-400", typeSpeed: 0 },
  { prompt: "~", msg: "python3 llm_eval.py --model claude --suite safety", color: "text-cyan", delay: 600, typeSpeed: 22 },
  { msg: "  ▸ Loading evaluation rubrics...", color: "text-text-body", typeSpeed: 0 },
  { msg: "  ✓ Security benchmarks: 847/847 passed", color: "text-green-400", typeSpeed: 0 },
  { prompt: "~", msg: "sentinelflow --live eth0 --rules ids.rules", color: "text-cyan", delay: 500, typeSpeed: 24 },
  { msg: "  ▸ Parsing 28M+ pkt/sec across 7 protocols", color: "text-text-body", typeSpeed: 0 },
  { msg: "  ✓ IDS engine active — 0 threats detected", color: "text-green-400", typeSpeed: 0 },
  { prompt: "#", msg: "bpftool prog list | head -3", color: "text-amber", delay: 500, typeSpeed: 20 },
  ...
  { msg: "  Throughput: 9.29M ops/sec · p50: 84ns", color: "text-green-400", typeSpeed: 0 },
];
...
const AMBIENT_LOGS: RawLog[] = [
  ...
  { msg: "EBPF   execve_monitor  pid=3847  /usr/bin/python3", color: "text-text-body" },
  { msg: "AI     adversarial probe  model=claude  blocked  ✓", color: "text-purple-400" },
  { msg: "WARN   phish_sim  social_eng_vector  flagged", color: "text-amber" },
  { msg: "NET    dns query  raoufabedini.dev  → CF", color: "text-text-body" },
  { msg: "ML     anomaly_detector  traffic_score=0.12  normal", color: "text-text-body" },
