...
import { ArrowRight, Download, Terminal, Code2, ShieldCheck, ChevronDown } from "lucide-react";
...
export default function Home() {
  return (
    <div className="space-y-24 pb-24 overflow-x-hidden">
      ...
      {/* --- SECTION 1: HERO --- */}
      <section className="relative min-h-screen px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col justify-center">

        <ActiveGrid />

        <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">

          {/* Left: Intro - orchestrated entrance */}
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-3 px-3 py-1 bg-cyan-500/5 border border-cyan-500/20 rounded-full"
            >
            ...
            >
              <DecryptedText text="Cybersecurity" loopInterval={5000} /> <br />
      ...
      <AnimatedSection variants={fadeInUp}>
        <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-0 border border-white/10 bg-zinc-900/20">
            {/* BUILD */}
            <AnimatedSection variants={fadeInLeft} className="border-b md:border-b-0 md:border-r border-white/10">
              <div className="p-8 md:p-12 group hover:bg-white/5 transition-colors h-full">
            ...
            {/* SECURE */}
            <AnimatedSection variants={fadeInRight} delay={0.15}>
              <div className="p-8 md:p-12 group hover:bg-white/5 transition-colors h-full">
                <div className="w-12 h-12 bg-zinc-800 rounded-sm flex items-center justify-center mb-6 group-hover:bg-purple/10 group-hover:text-purple transition-colors">
                ...
                <ul className="space-y-2 font-mono text-sm text-zinc-500">
                  <li className="flex items-center"><span className="text-purple mr-2">+</span> Threat Modelling</li>
                  <li className="flex items-center"><span className="text-purple mr-2">+</span> Privacy by Design</li>
                  <li className="flex items-center"><span className="text-purple mr-2">+</span> Defensive Coding</li>
                </ul>
              </div>
            </AnimatedSection>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <span className="text-amber font-mono animate-pulse">&#x25CF;</span>
