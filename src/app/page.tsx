...
function BentoCard({
  ...
  return (
    <motion.div
      variants={fadeInUp}
      className={`group relative p-6 border border-cyan/10 bg-[#06080d]/60 hover:shadow-[0_8px_32px_rgba(124,77,189,0.12)] ${accentHover} ${tint ?? ""} transition-all duration-300 cursor-pointer${className ? ` ${className}` : ""}`}
      whileHover={{ y: -6 }}
    >
      {children}
      {/* HUD corner markers */}
    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-end pr-0 lg:pr-24" aria-hidden="true">
          ...
          {/* Centre pip */}
          <div className="absolute w-2 h-2 rounded-full bg-cyan shadow-[0_0_16px_rgba(124,77,189,0.9)]" />
        </div>
          ...
          <div className="space-y-10">
            ...
            >
              <span className="relative flex h-2 w-2">
                ...
                <span className="relative rounded-full h-2 w-2 bg-cyan shadow-[0_0_8px_rgba(124,77,189,0.8)]" />
              </span>
            ...
            {(() => {
              ...
              return (
                <motion.div
                  key={p.slug}
                  variants={fadeInUp}
                  className={`group relative p-6 border border-cyan/10 bg-[#06080d]/60 hover:bg-cyan/[0.04] hover:shadow-[0_8px_32px_rgba(124,77,189,0.12)] ${s.hover} transition-all duration-300 md:col-span-2 cursor-pointer`}
                  whileHover={{ y: -6 }}
                >
                  <div className="flex items-start justify-between mb-5">
                    <span className={`font-mono text-[10px] px-2 py-0.5 border ${s.badge} tracking-widest uppercase`}>
            ...
            <AnimatedSection variants={fadeInLeft} className="border-b md:border-b-0 md:border-r border-cyan/10">
              <div className="relative p-10 md:p-14 group hover:bg-cyan/[0.03] transition-colors h-full overflow-hidden">
                ...
                <span
                  ...
                  style={{ color: "rgba(124,77,189,0.07)" } as React.CSSProperties}
                >
                  B
                </span>
