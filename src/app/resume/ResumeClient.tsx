          ...
          <AnimatedSection variants={fadeInUp}>
            <section className="space-y-4">
              ...
              <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid md:grid-cols-2 gap-4">
                <motion.div variants={fadeInUp} className="p-4 bg-cyan/5 border border-cyan/10 rounded-sm hover:border-cyan/30 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(0,245,255,0.1)] transition-all">
                ...
                <motion.div variants={fadeInUp} className="p-4 bg-purple/5 border border-purple/10 rounded-sm hover:border-purple/30 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(139,92,246,0.1)] transition-all">
                ...
                <motion.div variants={fadeInUp} className="p-4 bg-cyan/5 border border-cyan/10 rounded-sm hover:border-cyan/30 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(0,245,255,0.1)] transition-all md:col-span-2">
