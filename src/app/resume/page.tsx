...
export const metadata = {
  ...
  description: "Systems Support Analyst and Cybersecurity Student resume.",
};
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 text-zinc-400 text-sm font-mono">
                  <div className="flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-zinc-500" /> Sydney, NSW, Australia
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-zinc-500" /> raoof.r12@gmail.com
                  </div>
                </div>
              </div>
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 border border-white/5 rounded-sm hover:border-cyan/30 transition-colors">
            ...
            <div className="space-y-6">
              <div className="group">
                <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-2">
                  <h4 className="text-white font-bold text-lg group-hover:text-cyan transition-colors">MehrGuard — Offline QR & URL Security Scanner</h4>
               ...
               <div className="group">
                 <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-2">
                  <h4 className="text-white font-bold text-lg group-hover:text-cyan transition-colors">Syllabus Sync — Student Productivity Platform</h4>
           ...
           <section className="space-y-4">
             ...
             <div className="relative pl-6 border-l border-zinc-800">
                ...
                <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-1">
                  ...
                  <span className="text-zinc-500 font-mono text-sm">Iran Pharmacy | Aug 2019 – May 2024</span>
                </div>
           ...
           <section className="space-y-4 pb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-zinc-400">
              <div className="flex items-start gap-2">
                <span className="text-cyan mt-1">●</span> Eligible to work full-time in Australia (no restrictions)
              </div>
              <div className="flex items-start gap-2">
                <span className="text-cyan mt-1">●</span> Trilingual: English (Professional), Persian (Native), Japanese (Elementary)
              </div>
              <div className="flex items-start gap-2">
                <span className="text-cyan mt-1">●</span> Strong customer-focused communication skills
              </div>
              <div className="flex items-start gap-2">
                <span className="text-cyan mt-1">●</span> Calm and methodical under pressure
              </div>
            </div>
           </section>
