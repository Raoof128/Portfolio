      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <AnimatedSection variants={fadeInUp}>
          <div className="mb-12">
            ...
            <p className="text-zinc-400 max-w-2xl">Responsible disclosure guidelines for reporting security vulnerabilities.</p>
          </div>
        </AnimatedSection>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.05 }} className="space-y-8">
              ...
              <HUDFrame className="p-6 bg-zinc-900/50">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div><h4 className="text-white font-bold">Initial Response: 48-72 hours</h4><p className="text-zinc-400 text-sm">I will acknowledge receipt of your report and provide an initial assessment.</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-cyan/10 border border-cyan/30 shrink-0"><Shield className="w-5 h-5 text-cyan" /></div>
                    <div><h4 className="text-white font-bold">Resolution: 7-30 days</h4><p className="text-zinc-400 text-sm">Depending on severity, I will work to resolve the issue within this timeframe.</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-cyan/10 border border-cyan/30 shrink-0"><CheckCircle className="w-5 h-5 text-cyan" /></div>
                    <div><h4 className="text-white font-bold">Disclosure: Coordinated</h4><p className="text-zinc-400 text-sm">We will coordinate public disclosure after the fix is deployed.</p></div>
                  </div>
                </div>
              </HUDFrame>
            </section>
            ...
            <section className="space-y-4">
              ...
              <HUDFrame className="p-6 bg-zinc-900/50">
                <ul className="space-y-3 text-zinc-400">
                  ...
                  <li className="flex items-start gap-2"><span className="text-cyan mt-1">3.</span><span>Provide sufficient information to reproduce the vulnerability.</span></li>
                  <li className="flex items-start gap-2"><span className="text-cyan mt-1">4.</span><span>Give reasonable time to address the issue before public disclosure.</span></li>
                  <li className="flex items-start gap-2"><span className="text-cyan mt-1">5.</span><span>Act in good faith and avoid privacy violations.</span></li>
                </ul>
              </HUDFrame>
            </section>
          </AnimatedSection>
          ...
          <AnimatedSection variants={fadeInUp}>
            <section className="space-y-4">
              ...
              <HUDFrame className="p-6 bg-zinc-900/50">
                <p className="text-zinc-400 mb-4">For sensitive reports, you can encrypt your message using my PGP key:</p>
          ...
          <AnimatedSection variants={fadeInUp}>
            <section className="space-y-4">
              ...
              <HUDFrame className="p-6 bg-zinc-900/50">
                <p className="text-zinc-400 mb-4">I appreciate responsible security researchers who help improve the security of my projects. Valid reports may be acknowledged in the{" "}<Link href="/hall-of-fame" className="text-cyan hover:underline">Security Hall of Fame</Link>.</p>
                <p className="text-zinc-500 text-sm font-mono">Note: This is a personal portfolio project. No monetary bounties are offered, but your contribution will be recognized.</p>
              </HUDFrame>
            </section>
          </AnimatedSection>
        </motion.div>
