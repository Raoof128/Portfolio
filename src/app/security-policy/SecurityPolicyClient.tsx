      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <AnimatedSection variants={fadeInUp}>
          <div className="mb-12">
            ...
            <p className="text-text-body max-w-2xl">Responsible disclosure guidelines for reporting security vulnerabilities.</p>
          </div>
        </AnimatedSection>
            ...
            <HUDFrame className="p-6 md:p-8 bg-cyan/5 border-l-4 border-l-cyan">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-text-body">Found a security issue? Contact me directly at{" "}<a href={reportLink} className="text-cyan hover:underline">{CONTACT_EMAIL}</a></p>
                </div>
              ...
              <HUDFrame className="p-6 bg-[#06080d]/60">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div><h4 className="text-white font-bold">Initial Response: 48-72 hours</h4><p className="text-text-body text-sm">I will acknowledge receipt of your report and provide an initial assessment.</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div><h4 className="text-white font-bold">Resolution: 7-30 days</h4><p className="text-text-body text-sm">Depending on severity, I will work to resolve the issue within this timeframe.</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div><h4 className="text-white font-bold">Disclosure: Coordinated</h4><p className="text-text-body text-sm">We will coordinate public disclosure after the fix is deployed.</p></div>
                  </div>
                </div>
              </HUDFrame>
            </section>
