...
export const metadata = {
  ...
  description: "Security researchers who have responsibly disclosed vulnerabilities in my projects.",
};
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
                  <Shield className="w-5 h-5 text-cyan" /> Found a Vulnerability?
                </h2>
                <p className="text-zinc-400">
                  Report it responsibly and get recognized here. Check my{" "}
                  <Link href="/security-policy" className="text-cyan hover:underline">
                    security policy
                  </Link>{" "}
                  for guidelines.
                </p>
              ...
              <NeonButton href="mailto:raoof.r12@gmail.com" variant="primary">
                <Mail className="w-4 h-4 mr-2" /> REPORT
              </NeonButton>
            </div>
          </HUDFrame>
              ...
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 max-w-md mx-auto">
                    This page is waiting for its first security researcher. Find a vulnerability, 
                    report it responsibly, and become the first to be recognized.
                  </p>
                </div>
                <div className="pt-4">
                  <span className="inline-flex items-center text-xs font-mono text-zinc-600 bg-zinc-800/50 px-3 py-1 rounded-full">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white flex items-center gap-2">
              <span className="text-cyan font-mono">01.</span> Recognition Criteria
            </h2>
            <HUDFrame className="p-6 bg-zinc-900/50">
              <p className="text-zinc-400 mb-4">
                To be listed in the Hall of Fame, researchers must:
              </p>
              <ul className="space-y-2 text-zinc-300">
                <li className="flex items-start gap-2">
                  <span className="text-cyan mt-0.5">1.</span>
                  <span>Report a valid, in-scope security vulnerability</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan mt-0.5">2.</span>
                  <span>Follow responsible disclosure guidelines</span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Not publicly disclose the vulnerability before coordination</span>
                </li>
              </ul>
            </HUDFrame>
          </section>
          ...
          {/* Note */}
          <section className="space-y-4">
            <HUDFrame className="p-6 bg-zinc-900/50 border-l-4 border-l-yellow-500/50">
              <p className="text-zinc-400 text-sm">
                <span className="text-yellow-400 font-bold">Note:</span> This is a personal portfolio project. 
                While I deeply appreciate security research efforts, no monetary bounties are offered. 
                Recognition in this Hall of Fame is the primary acknowledgment for valid reports.
              </p>
            </HUDFrame>
          </section>
