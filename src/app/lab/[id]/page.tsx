...
export default async function LabExperimentPage({ params }: PageProps) {
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-12 overflow-x-hidden">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
